class StaffScheduleApp {
  ...
  createAvailabilityDropdown(dateStr, shiftType) {
    ...
    // Pre-fill saved value so changing months keeps selections and notes
    ...
    select.addEventListener('change', () => {
      ...
      // Training/Vacation adjacency rules
      ...
      // Availability adjacency rules vs Training/Vacation
      if (newVal === 'A') {
        if (shift === 'Day') {
          if (
