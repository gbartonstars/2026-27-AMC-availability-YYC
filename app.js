class StaffScheduleApp {
    constructor() {
        ...
        this.octokit = new Octokit({
            auth: 'YOUR_GITHUB_OAUTH_TOKEN' // Replace with your GitHub OAuth token
        });
        this.repoOwner = 'YOUR_GITHUB_USERNAME'; // Replace with your GitHub repo owner
        this.repoName = 'YOUR_REPO_NAME'; // Replace with your GitHub repo name
