class StaffScheduleApp {
    constructor() {
        ...
        // GitHub API setup - replace with real auth and repo info
    ...
    async onStaffChange(e) {
        ...
        this.masterCalendarActive = false;
        this.sharedInputActive = false;
        if (this.privilegedUsers.has(staffName)) this.privilegedAuthenticated = true;
        await this.loadAvailability(staffName);
        this.showSchedule();
    }
    ...
    createAvailabilityDropdown(dateStr, shiftType) {
        ...
        select.addEventListener('change', async e => {
            ...
            console.log(`[DEBUG] Availability changed: ${key} = ${e.target.value}`);
            this.updateAvailabilitySummary();
    ...
    updateAvailabilitySummary() {
        ...
        console.log("[DEBUG] Updating availability summary with ", data);
