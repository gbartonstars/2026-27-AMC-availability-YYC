class StaffScheduleApp {
  constructor() {
    ...
    // Central store for main availability:
    // allAvailability[staff][dateStr] = { Day, Night, DayTrainingNote, NightTrainingNote }
    this.allAvailability = {};

    // Ideal schedule store:
    // idealAvailability[staff][dateStr] = { Day, Night, DayTrainingNote, NightTrainingNote }
  ...
  async onStaffChange(e) {
    ...
    // Show Ideal tab only for Greg, Scott, Stuart, Graham
  ...
  renderIdealCalendar() {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      // Allow editing if current user is one of the ideal users
