class StaffScheduleApp {
    constructor() {
        ...
        this.scheduleData = {};
        this.masterCalendarActive = false; // Flag for master calendar view
        this.bindEvents();
    }
    ...
    changeMonth(direction) {
        ...
        if (this.masterCalendarActive) {
            this.showMasterCalendar();
        } else {
            this.renderCalendar();
        }
    }
    ...
    showMasterCalendar() {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            dayShiftEl.style.backgroundColor = '#fff59d'; // yellow
            ...
            nightShiftEl.style.backgroundColor = '#90caf9'; // blue
